...
namespace SchoolManagementSystem.Helpers
{
    public class UserHelper : IUserHelper
    {
        ...
        public UserHelper(UserManager<User> userManager, SignInManager<User> signInManager, RoleManager<IdentityRole> roleManager, IEmployeeRepository employeeRepository, IStudentRepository studentRepository, ITeacherRepository teacherRepository, IAlertRepository alertRepository)
        {
