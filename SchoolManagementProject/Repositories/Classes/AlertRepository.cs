...
namespace SchoolManagementSystem.Repositories
{
    public class AlertRepository : GenericRepository<Alert>, IAlertRepository
    {
        ...
        {
            return await _context.Alerts.Where(a => !a.IsResolved).Include(a => a.Employee).ToListAsync();
        }
        ...
        {
            return await _context.Alerts.Where(a => a.EmployeeId == employeeId).Include(a => a.Employee).ToListAsync();
        }
