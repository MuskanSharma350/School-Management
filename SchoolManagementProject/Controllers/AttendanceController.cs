...
namespace SchoolManagementSystem.Controllers
{
    ...
    public class AttendanceController : Controller
    {
        ...
        public AttendanceController(IAttendanceRepository attendanceRepository, IStudentRepository studentRepository, ISubjectRepository subjectRepository, IConverterHelper converterHelper, ISchoolClassRepository schoolClassRepository, ILogger<AttendanceController> logger)
        {
