...
namespace SchoolManagementSystem.Controllers
{
    ...
    public class GradesController : Controller
    {
        ...
        public GradesController(IGradeRepository gradeRepository, IStudentRepository studentRepository, ISchoolClassRepository schoolClassRepository, IConverterHelper converterHelper, ISubjectRepository subjectRepository, ILogger<GradesController> logger)
        {
