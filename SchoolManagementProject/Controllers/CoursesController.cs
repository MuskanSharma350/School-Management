...
namespace SchoolManagementSystem.Controllers
{
    ...
    public class CoursesController : Controller
    {
        ...
        public CoursesController(ICourseRepository courseRepository, ISchoolClassRepository schoolClassRepository, ISubjectRepository subjectRepository, IConverterHelper converterHelper, ILogger<CoursesController> logger)
        {
