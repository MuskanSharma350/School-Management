...
public class SeedDb
{
    ...
    public async Task SeedAsync()
    {
        ...
        var pendingUser1 = await CreateUserAsync("pending1@school.com", "Pending1", "User", "Pending123!", "Pending");
        var pendingUser2 = await CreateUserAsync("pending2@school.com", "Pending2", "User", "Pending123!", "Pending");
        var pendingUser3 = await CreateUserAsync("pending3@school.com", "Pending2", "User", "Pending123!", "Pending");
